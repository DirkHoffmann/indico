...
Indico has replaced CDS Agenda as the only CERN event management
software at the beginning of this century, as well as in many
other institutions, who are former users of the CDS Agenda software. 
The developement of Indico was motivated by the fact that
CDS Agenda was not able to cope with the administration of bigger
events such as workshops and conferences which are regularly organised 
in and by scientific institutions worldwide.
...
video or phone conference bookings, participant management, room booking and\
paper reviewing. More are to come
and Indico can already be considered a really
...
On CERN-Indico you may use your CERN SSO account. If you don't have one, then
choose the "If you don't have an account" section of the login page.

|image2|

The "remind me of my password" feature works only with local Indico
accounts, not with other user registries like NICE (at CERN) or LDAP, 
which is used in some Indico instances for central user administration.
